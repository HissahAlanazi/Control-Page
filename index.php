...
<meta charsat="utf-8">
	...
	‏    <td> <div class="Stop"><input type="submit" value=" Stop " name = "stop" style="font-size: 40px; background:background:linear-gradient(to right bottom,#d13cff,#031f6a); border-radius: 60px; color: white; padding: 20px; "> </td></div>
